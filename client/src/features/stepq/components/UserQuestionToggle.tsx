...
const UserQuestionToggle: React.FC<UserQuestionToggleProps> = ({ onChange }) => {
  ...
  return (
    ...
    >
      <button
        ...
        style={{
          ...buttonBaseStyle,
          background: view === 'user' ? selectedBtnBg : unselectedBtnBg,
          color: view === 'user' ? '#fff' : '#1e293b',
        }}
      >
        👤 User
      </button>
      <button
        ...
        style={{
          ...buttonBaseStyle,
          background: view === 'question' ? selectedBtnBg : unselectedBtnBg,
          color: view === 'question' ? '#fff' : '#1e293b',
        }}
      >
        ❓ Question
      </button>
